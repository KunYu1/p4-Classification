...
class ActionProfile_SumOfMembers;
class ActionProfile_SumOfMembersDefaultTypeInternal;
extern ActionProfile_SumOfMembersDefaultTypeInternal _ActionProfile_SumOfMembers_default_instance_;
class ActionProfile_SumOfWeights;
class ActionProfile_SumOfWeightsDefaultTypeInternal;
extern ActionProfile_SumOfWeightsDefaultTypeInternal _ActionProfile_SumOfWeights_default_instance_;
class ActionRef;
...
extern PlatformPropertiesDefaultTypeInternal _PlatformProperties_default_instance_;
class Preamble;
...
template<> ::p4::config::v1::ActionProfile_SumOfMembers* Arena::CreateMaybeMessage<::p4::config::v1::ActionProfile_SumOfMembers>(Arena*);
template<> ::p4::config::v1::ActionProfile_SumOfWeights* Arena::CreateMaybeMessage<::p4::config::v1::ActionProfile_SumOfWeights>(Arena*);
...
template<> ::p4::config::v1::PlatformProperties* Arena::CreateMaybeMessage<::p4::config::v1::PlatformProperties>(Arena*);
...
class PlatformProperties : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:p4.config.v1.PlatformProperties) */ {
 public:
  PlatformProperties();
  ...
  void Swap(PlatformProperties* other);
  ...
  inline PlatformProperties* New() const final {
    return CreateMaybeMessage<PlatformProperties>(NULL);
  }

  PlatformProperties* New(::google::protobuf::Arena* arena) const final {
  ...
  void clear_multicast_group_table_size();
  static const int kMulticastGroupTableSizeFieldNumber = 1;
  ::google::protobuf::int32 multicast_group_table_size() const;
  void set_multicast_group_table_size(::google::protobuf::int32 value);

  // int32 multicast_group_table_total_replicas = 2;
  void clear_multicast_group_table_total_replicas();
  static const int kMulticastGroupTableTotalReplicasFieldNumber = 2;
  ::google::protobuf::int32 multicast_group_table_total_replicas() const;
  void set_multicast_group_table_total_replicas(::google::protobuf::int32 value);

  // int32 multicast_group_table_max_replicas_per_entry = 3;
  void clear_multicast_group_table_max_replicas_per_entry();
  static const int kMulticastGroupTableMaxReplicasPerEntryFieldNumber = 3;
  ::google::protobuf::int32 multicast_group_table_max_replicas_per_entry() const;
  void set_multicast_group_table_max_replicas_per_entry(::google::protobuf::int32 value);

  // @@protoc_insertion_point(class_scope:p4.config.v1.PlatformProperties)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::int32 multicast_group_table_size_;
  ::google::protobuf::int32 multicast_group_table_total_replicas_;
  ::google::protobuf::int32 multicast_group_table_max_replicas_per_entry_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_p4_2fconfig_2fv1_2fp4info_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class PkgInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:p4.config.v1.PkgInfo) */ {
 public:
  ...
  bool has_platform_properties() const;
  void clear_platform_properties();
  static const int kPlatformPropertiesFieldNumber = 11;
  private:
  const ::p4::config::v1::PlatformProperties& _internal_platform_properties() const;
  public:
  const ::p4::config::v1::PlatformProperties& platform_properties() const;
  ::p4::config::v1::PlatformProperties* release_platform_properties();
  ::p4::config::v1::PlatformProperties* mutable_platform_properties();
  void set_allocated_platform_properties(::p4::config::v1::PlatformProperties* platform_properties);
 ...
 private:
  ...
  ::p4::config::v1::PlatformProperties* platform_properties_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_p4_2fconfig_2fv1_2fp4info_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class Table : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:p4.config.v1.Table) */ {
 public:
  ...
  void clear_has_initial_entries();
  static const int kHasInitialEntriesFieldNumber = 11;
  bool has_initial_entries() const;
  void set_has_initial_entries(bool value);
...
class ActionProfile_SumOfWeights : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:p4.config.v1.ActionProfile.SumOfWeights) */ {
 public:
  ActionProfile_SumOfWeights();
  virtual ~ActionProfile_SumOfWeights();

  ActionProfile_SumOfWeights(const ActionProfile_SumOfWeights& from);

  inline ActionProfile_SumOfWeights& operator=(const ActionProfile_SumOfWeights& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  ActionProfile_SumOfWeights(ActionProfile_SumOfWeights&& from) noexcept
    : ActionProfile_SumOfWeights() {
    *this = ::std::move(from);
  }

  inline ActionProfile_SumOfWeights& operator=(ActionProfile_SumOfWeights&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  #endif
  static const ::google::protobuf::Descriptor* descriptor();
  static const ActionProfile_SumOfWeights& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const ActionProfile_SumOfWeights* internal_default_instance() {
    return reinterpret_cast<const ActionProfile_SumOfWeights*>(
               &_ActionProfile_SumOfWeights_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    13;

  void Swap(ActionProfile_SumOfWeights* other);
  friend void swap(ActionProfile_SumOfWeights& a, ActionProfile_SumOfWeights& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline ActionProfile_SumOfWeights* New() const final {
    return CreateMaybeMessage<ActionProfile_SumOfWeights>(NULL);
  }

  ActionProfile_SumOfWeights* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<ActionProfile_SumOfWeights>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
  void CopyFrom(const ActionProfile_SumOfWeights& from);
  void MergeFrom(const ActionProfile_SumOfWeights& from);
  void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ActionProfile_SumOfWeights* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
...
class ActionProfile_SumOfMembers : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:p4.config.v1.ActionProfile.SumOfMembers) */ {
 public:
  ActionProfile_SumOfMembers();
  virtual ~ActionProfile_SumOfMembers();

  ActionProfile_SumOfMembers(const ActionProfile_SumOfMembers& from);

  inline ActionProfile_SumOfMembers& operator=(const ActionProfile_SumOfMembers& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  ActionProfile_SumOfMembers(ActionProfile_SumOfMembers&& from) noexcept
    : ActionProfile_SumOfMembers() {
    *this = ::std::move(from);
  }

  inline ActionProfile_SumOfMembers& operator=(ActionProfile_SumOfMembers&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  #endif
  static const ::google::protobuf::Descriptor* descriptor();
  static const ActionProfile_SumOfMembers& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const ActionProfile_SumOfMembers* internal_default_instance() {
    return reinterpret_cast<const ActionProfile_SumOfMembers*>(
               &_ActionProfile_SumOfMembers_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    14;

  void Swap(ActionProfile_SumOfMembers* other);
  friend void swap(ActionProfile_SumOfMembers& a, ActionProfile_SumOfMembers& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline ActionProfile_SumOfMembers* New() const final {
    return CreateMaybeMessage<ActionProfile_SumOfMembers>(NULL);
  }

  ActionProfile_SumOfMembers* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<ActionProfile_SumOfMembers>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
  void CopyFrom(const ActionProfile_SumOfMembers& from);
  void MergeFrom(const ActionProfile_SumOfMembers& from);
  void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ActionProfile_SumOfMembers* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  void clear_max_member_weight();
  static const int kMaxMemberWeightFieldNumber = 1;
  ::google::protobuf::int32 max_member_weight() const;
  void set_max_member_weight(::google::protobuf::int32 value);

  // @@protoc_insertion_point(class_scope:p4.config.v1.ActionProfile.SumOfMembers)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::int32 max_member_weight_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_p4_2fconfig_2fv1_2fp4info_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class ActionProfile : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:p4.config.v1.ActionProfile) */ {
 public:
  ...
  enum SelectorSizeSemanticsCase {
    kSumOfWeights = 6,
    kSumOfMembers = 7,
    SELECTOR_SIZE_SEMANTICS_NOT_SET = 0,
  };
  ...
  typedef ActionProfile_SumOfWeights SumOfWeights;
  typedef ActionProfile_SumOfMembers SumOfMembers;
  ...
  bool has_sum_of_weights() const;
  void clear_sum_of_weights();
  static const int kSumOfWeightsFieldNumber = 6;
  private:
  const ::p4::config::v1::ActionProfile_SumOfWeights& _internal_sum_of_weights() const;
  public:
  const ::p4::config::v1::ActionProfile_SumOfWeights& sum_of_weights() const;
  ::p4::config::v1::ActionProfile_SumOfWeights* release_sum_of_weights();
  ::p4::config::v1::ActionProfile_SumOfWeights* mutable_sum_of_weights();
  void set_allocated_sum_of_weights(::p4::config::v1::ActionProfile_SumOfWeights* sum_of_weights);

  // .p4.config.v1.ActionProfile.SumOfMembers sum_of_members = 7;
  bool has_sum_of_members() const;
  void clear_sum_of_members();
  static const int kSumOfMembersFieldNumber = 7;
  private:
  const ::p4::config::v1::ActionProfile_SumOfMembers& _internal_sum_of_members() const;
  public:
  const ::p4::config::v1::ActionProfile_SumOfMembers& sum_of_members() const;
  ::p4::config::v1::ActionProfile_SumOfMembers* release_sum_of_members();
  ::p4::config::v1::ActionProfile_SumOfMembers* mutable_sum_of_members();
  void set_allocated_sum_of_members(::p4::config::v1::ActionProfile_SumOfMembers* sum_of_members);

  void clear_selector_size_semantics();
  SelectorSizeSemanticsCase selector_size_semantics_case() const;
  // @@protoc_insertion_point(class_scope:p4.config.v1.ActionProfile)
 private:
  void set_has_sum_of_weights();
  void set_has_sum_of_members();

  inline bool has_selector_size_semantics() const;
  inline void clear_has_selector_size_semantics();
  ...
  union SelectorSizeSemanticsUnion {
    SelectorSizeSemanticsUnion() {}
    ::p4::config::v1::ActionProfile_SumOfWeights* sum_of_weights_;
    ::p4::config::v1::ActionProfile_SumOfMembers* sum_of_members_;
  } selector_size_semantics_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  ::google::protobuf::uint32 _oneof_case_[1];
...
// int32 multicast_group_table_size = 1;
inline void PlatformProperties::clear_multicast_group_table_size() {
  multicast_group_table_size_ = 0;
}
inline ::google::protobuf::int32 PlatformProperties::multicast_group_table_size() const {
  // @@protoc_insertion_point(field_get:p4.config.v1.PlatformProperties.multicast_group_table_size)
  return multicast_group_table_size_;
}
inline void PlatformProperties::set_multicast_group_table_size(::google::protobuf::int32 value) {
  
  multicast_group_table_size_ = value;
  // @@protoc_insertion_point(field_set:p4.config.v1.PlatformProperties.multicast_group_table_size)
}

// int32 multicast_group_table_total_replicas = 2;
inline void PlatformProperties::clear_multicast_group_table_total_replicas() {
  multicast_group_table_total_replicas_ = 0;
}
inline ::google::protobuf::int32 PlatformProperties::multicast_group_table_total_replicas() const {
  // @@protoc_insertion_point(field_get:p4.config.v1.PlatformProperties.multicast_group_table_total_replicas)
  return multicast_group_table_total_replicas_;
}
inline void PlatformProperties::set_multicast_group_table_total_replicas(::google::protobuf::int32 value) {
  
  multicast_group_table_total_replicas_ = value;
  // @@protoc_insertion_point(field_set:p4.config.v1.PlatformProperties.multicast_group_table_total_replicas)
}

// int32 multicast_group_table_max_replicas_per_entry = 3;
inline void PlatformProperties::clear_multicast_group_table_max_replicas_per_entry() {
  multicast_group_table_max_replicas_per_entry_ = 0;
}
inline ::google::protobuf::int32 PlatformProperties::multicast_group_table_max_replicas_per_entry() const {
  // @@protoc_insertion_point(field_get:p4.config.v1.PlatformProperties.multicast_group_table_max_replicas_per_entry)
  return multicast_group_table_max_replicas_per_entry_;
}
inline void PlatformProperties::set_multicast_group_table_max_replicas_per_entry(::google::protobuf::int32 value) {
  
  multicast_group_table_max_replicas_per_entry_ = value;
  // @@protoc_insertion_point(field_set:p4.config.v1.PlatformProperties.multicast_group_table_max_replicas_per_entry)
}
...
// .p4.config.v1.PlatformProperties platform_properties = 11;
inline bool PkgInfo::has_platform_properties() const {
  return this != internal_default_instance() && platform_properties_ != NULL;
}
inline void PkgInfo::clear_platform_properties() {
  if (GetArenaNoVirtual() == NULL && platform_properties_ != NULL) {
    delete platform_properties_;
  }
  platform_properties_ = NULL;
}
inline const ::p4::config::v1::PlatformProperties& PkgInfo::_internal_platform_properties() const {
  return *platform_properties_;
}
inline const ::p4::config::v1::PlatformProperties& PkgInfo::platform_properties() const {
  const ::p4::config::v1::PlatformProperties* p = platform_properties_;
  // @@protoc_insertion_point(field_get:p4.config.v1.PkgInfo.platform_properties)
  return p != NULL ? *p : *reinterpret_cast<const ::p4::config::v1::PlatformProperties*>(
      &::p4::config::v1::_PlatformProperties_default_instance_);
}
inline ::p4::config::v1::PlatformProperties* PkgInfo::release_platform_properties() {
  // @@protoc_insertion_point(field_release:p4.config.v1.PkgInfo.platform_properties)
  
  ::p4::config::v1::PlatformProperties* temp = platform_properties_;
  platform_properties_ = NULL;
  return temp;
}
inline ::p4::config::v1::PlatformProperties* PkgInfo::mutable_platform_properties() {
  
  if (platform_properties_ == NULL) {
    auto* p = CreateMaybeMessage<::p4::config::v1::PlatformProperties>(GetArenaNoVirtual());
    platform_properties_ = p;
  }
  // @@protoc_insertion_point(field_mutable:p4.config.v1.PkgInfo.platform_properties)
  return platform_properties_;
}
inline void PkgInfo::set_allocated_platform_properties(::p4::config::v1::PlatformProperties* platform_properties) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete platform_properties_;
  }
  if (platform_properties) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      platform_properties = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, platform_properties, submessage_arena);
    }
    
  } else {
    
  }
  platform_properties_ = platform_properties;
  // @@protoc_insertion_point(field_set_allocated:p4.config.v1.PkgInfo.platform_properties)
}
...
// bool has_initial_entries = 11;
inline void Table::clear_has_initial_entries() {
  has_initial_entries_ = false;
}
inline bool Table::has_initial_entries() const {
  // @@protoc_insertion_point(field_get:p4.config.v1.Table.has_initial_entries)
  return has_initial_entries_;
}
inline void Table::set_has_initial_entries(bool value) {
  
  has_initial_entries_ = value;
  // @@protoc_insertion_point(field_set:p4.config.v1.Table.has_initial_entries)
}
...
// int32 max_member_weight = 1;
inline void ActionProfile_SumOfMembers::clear_max_member_weight() {
  max_member_weight_ = 0;
}
inline ::google::protobuf::int32 ActionProfile_SumOfMembers::max_member_weight() const {
  // @@protoc_insertion_point(field_get:p4.config.v1.ActionProfile.SumOfMembers.max_member_weight)
  return max_member_weight_;
}
inline void ActionProfile_SumOfMembers::set_max_member_weight(::google::protobuf::int32 value) {
  
  max_member_weight_ = value;
  // @@protoc_insertion_point(field_set:p4.config.v1.ActionProfile.SumOfMembers.max_member_weight)
}
...
// .p4.config.v1.ActionProfile.SumOfWeights sum_of_weights = 6;
inline bool ActionProfile::has_sum_of_weights() const {
  return selector_size_semantics_case() == kSumOfWeights;
}
inline void ActionProfile::set_has_sum_of_weights() {
  _oneof_case_[0] = kSumOfWeights;
}
inline void ActionProfile::clear_sum_of_weights() {
  if (has_sum_of_weights()) {
    delete selector_size_semantics_.sum_of_weights_;
    clear_has_selector_size_semantics();
  }
}
inline const ::p4::config::v1::ActionProfile_SumOfWeights& ActionProfile::_internal_sum_of_weights() const {
  return *selector_size_semantics_.sum_of_weights_;
}
inline ::p4::config::v1::ActionProfile_SumOfWeights* ActionProfile::release_sum_of_weights() {
  // @@protoc_insertion_point(field_release:p4.config.v1.ActionProfile.sum_of_weights)
  if (has_sum_of_weights()) {
    clear_has_selector_size_semantics();
      ::p4::config::v1::ActionProfile_SumOfWeights* temp = selector_size_semantics_.sum_of_weights_;
    selector_size_semantics_.sum_of_weights_ = NULL;
    return temp;
  } else {
    return NULL;
  }
}
inline const ::p4::config::v1::ActionProfile_SumOfWeights& ActionProfile::sum_of_weights() const {
  // @@protoc_insertion_point(field_get:p4.config.v1.ActionProfile.sum_of_weights)
  return has_sum_of_weights()
      ? *selector_size_semantics_.sum_of_weights_
      : *reinterpret_cast< ::p4::config::v1::ActionProfile_SumOfWeights*>(&::p4::config::v1::_ActionProfile_SumOfWeights_default_instance_);
}
inline ::p4::config::v1::ActionProfile_SumOfWeights* ActionProfile::mutable_sum_of_weights() {
  if (!has_sum_of_weights()) {
    clear_selector_size_semantics();
    set_has_sum_of_weights();
    selector_size_semantics_.sum_of_weights_ = CreateMaybeMessage< ::p4::config::v1::ActionProfile_SumOfWeights >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:p4.config.v1.ActionProfile.sum_of_weights)
  return selector_size_semantics_.sum_of_weights_;
}

// .p4.config.v1.ActionProfile.SumOfMembers sum_of_members = 7;
inline bool ActionProfile::has_sum_of_members() const {
  return selector_size_semantics_case() == kSumOfMembers;
}
inline void ActionProfile::set_has_sum_of_members() {
  _oneof_case_[0] = kSumOfMembers;
}
inline void ActionProfile::clear_sum_of_members() {
  if (has_sum_of_members()) {
    delete selector_size_semantics_.sum_of_members_;
    clear_has_selector_size_semantics();
  }
}
inline const ::p4::config::v1::ActionProfile_SumOfMembers& ActionProfile::_internal_sum_of_members() const {
  return *selector_size_semantics_.sum_of_members_;
}
inline ::p4::config::v1::ActionProfile_SumOfMembers* ActionProfile::release_sum_of_members() {
  // @@protoc_insertion_point(field_release:p4.config.v1.ActionProfile.sum_of_members)
  if (has_sum_of_members()) {
    clear_has_selector_size_semantics();
      ::p4::config::v1::ActionProfile_SumOfMembers* temp = selector_size_semantics_.sum_of_members_;
    selector_size_semantics_.sum_of_members_ = NULL;
    return temp;
  } else {
    return NULL;
  }
}
inline const ::p4::config::v1::ActionProfile_SumOfMembers& ActionProfile::sum_of_members() const {
  // @@protoc_insertion_point(field_get:p4.config.v1.ActionProfile.sum_of_members)
  return has_sum_of_members()
      ? *selector_size_semantics_.sum_of_members_
      : *reinterpret_cast< ::p4::config::v1::ActionProfile_SumOfMembers*>(&::p4::config::v1::_ActionProfile_SumOfMembers_default_instance_);
}
inline ::p4::config::v1::ActionProfile_SumOfMembers* ActionProfile::mutable_sum_of_members() {
  if (!has_sum_of_members()) {
    clear_selector_size_semantics();
    set_has_sum_of_members();
    selector_size_semantics_.sum_of_members_ = CreateMaybeMessage< ::p4::config::v1::ActionProfile_SumOfMembers >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:p4.config.v1.ActionProfile.sum_of_members)
  return selector_size_semantics_.sum_of_members_;
}

inline bool ActionProfile::has_selector_size_semantics() const {
  return selector_size_semantics_case() != SELECTOR_SIZE_SEMANTICS_NOT_SET;
}
inline void ActionProfile::clear_has_selector_size_semantics() {
  _oneof_case_[0] = SELECTOR_SIZE_SEMANTICS_NOT_SET;
}
inline ActionProfile::SelectorSizeSemanticsCase ActionProfile::selector_size_semantics_case() const {
  return ActionProfile::SelectorSizeSemanticsCase(_oneof_case_[0]);
}
// -------------------------------------------------------------------
